 ...
 */
package net.redstonecraft.redstoneapi.data.json.parser;
...
public class JSONParser {
	...
	public static JSONObject parseObject(String s) throws ParseException {
		return (JSONObject) new JSONParser().parse(s);
	}

	public static JSONObject parseObject(byte[] data) throws ParseException {
		return parseObject(new String(data, StandardCharsets.UTF_8));
	}
	...
	public static JSONArray parseArray(byte[] data) {
		return parseArray(new String(data, StandardCharsets.UTF_8));
	}
