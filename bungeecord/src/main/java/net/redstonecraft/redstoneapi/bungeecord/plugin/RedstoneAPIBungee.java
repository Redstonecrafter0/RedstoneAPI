package net.redstonecraft.redstoneapi.bungeecord.plugin;

import net.md_5.bungee.api.ProxyServer;
import net.redstonecraft.redstoneapi.info.RedstoneAPI;
import net.redstonecraft.redstoneapi.bungeecord.BungeecordPlugin;
...
//            }
            userManager = new UserManager(null, getConfig().getBoolean("usermanager.fetchonmissing"), getConfig().getInt("usermanager.persistance") * 24 * 60 * 60 * 1000);
