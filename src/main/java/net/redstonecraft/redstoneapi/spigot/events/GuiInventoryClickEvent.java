...
import net.redstonecraft.redstoneapi.spigot.obj.GuiOptionStates;
...
/**
 * This event is fired when an inventory from the {@link net.redstonecraft.redstoneapi.spigot.manager.GuiInventoryManager} is used
 *
