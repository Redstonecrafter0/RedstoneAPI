package net.redstonecraft.redstoneapi.bungee.manager;

import net.md_5.bungee.api.connection.PendingConnection;
import net.md_5.bungee.api.connection.ProxiedPlayer;
import net.redstonecraft.redstoneapi.bungee.obj.User;
...
public class UserManager {
     ...
     * */
    public UserManager(SQL sql, boolean fetchOnMissing, int persistance) {
        this.sql = sql;
